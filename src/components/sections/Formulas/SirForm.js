    ...
    return (
      <Accordion defaultActiveKey="8">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            Es el procedimiento mediante el cual se aumenta de manera rápida la
            presión parcial arterial de oxígeno (PaO2) como medida de seguridad
            durante el periodo apnéico del proceso de intubación orotraqueal,
            posterior a la administración de la sedación y relajación muscular.
            Su propósito es reemplazar el nitrógeno que se encuentra en la vía
            aérea (capacidad funcional residual) por altas concentraciones de
            oxígeno para permitir el aumento del tiempo de paro respiratorio
            hasta en cinco minutos en pacientes normoxémicos, sin que presenten
            índices críticos de hipoxemia definida como una saturación menor al
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            ...
            <Texto1 id="texto1">
              ...
              efectos hemodinámicos, respiratorios o metabólicos causen riesgo a
              la vida o empeoren las condiciones de salud de los individuos que
              ...
              <DatosPreTx>
                ...
                <div id="datos">
                  ...
                  fentanilo. <br />
                  2) Son medicamentos que pueden producir hipotensión y no deben
                  emplearse en condiciones de choque no resuelto.
                  <br />
                  3) Disminuyen los requerimientos de los medicamentos
                  inductores para lograr unas buenas condiciones para intubación
                  traqueal.
                  <br />
                </div>
              </DatosPreTx>
              <Induccion>
                <div id="induccion">
                  ...
                  <p>
                    ...
                    paciente para poder llevar a cabo la intubación traqueal, se
                    debe de recordar que <u>sedación</u> o <u>somnolencia</u> no
                    es sinónimo de analgesia, y en determinadas circunstancias
                    clínicas que precisan una SIR, es necesario que el control
                    del dolor sea parte integral del propósito que debe alcanzar
                    el equipo de salud en la atención del paciente en el
                    servicio de urgencias.
                  </p>
                  <p>
                    Los medicamentos estan dividos en:{" "}
                    <strong>barbitúricos:</strong> (pentobarbital o tiopental),{" "}
                    <strong>opioides de acción corta:</strong> (fentanilo),{" "}
                    <strong>sedantes no barbitúricos: </strong> (propofol,
                    etomidato y benzodiacepinas) y{" "}
                    <strong>anestésicos disociativos: </strong> Ketamina
                  </p>
                  <p>
                    <strong>Ketamina: </strong> De elección en pacientes con
                    asma severa que requieran SIR por su efecto betaestimulante
                    indirecto. <u>Dosis:</u> 0.5 a 2 mg/kg | 50 mg por cada 1 ml
                    presentación de 10 ml | 100 kg = 100 mg = 2 ml
                  </p>
                  <p>
                    <strong>Fentanilo: </strong> Efecto analgesico importante y
                    sedación profunda. <u>Dosis:</u> 5 mcg/kg | 1 amp = 10 ml =
                    0.5 mg | 100 kg = 10 ml
                  </p>
                  <p>
                    <strong>Midazolam: </strong> Benzodiacepina de inicio rapido
                    y acción corta, disminuir dosis en pacientes renales o
                    hepaticos, precaución induce apnea. <u>Dosis:</u> 0.05 a 0.2
                    mg/kg | 1 amp = 3 ml = 15 mg | 100 kg = 10 mg = 2 ml
                  </p>
                  <p>
                    <strong>Etomidato: </strong> Ideal para pacientes con
                    choque, politrauma (incluido TCE) y enfermedades coronarias.{" "}
                    <u>Dosis:</u> 0.3 mg/kg | 20 mg = 10 ml | 100 kg = 30 mg =
                    15 ml | 6.6 ml por cada 10 kg
                  </p>
                  <p>
        ...
        <Accordion.Item eventKey="3">
          ...
          <Accordion.Body>
            <div>
              ...
              <p>
                <strong>LE: </strong> <u>Lesón Externa</u>:, Investigar 3-3-2, 3
                dedos entre incisivos, 3 dedos entre hueso hiodes y el menton y
              ...
              <p>
                <strong>N: </strong>
                <u>No</u>: movilización del cuello en aquellos casos en donde se
                sospeche de una lesión o lesiva en su movimiento.
              </p>
            </div>
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="4">
          ...
          <Accordion.Body>
            <p>
              Se dividen en dos tipos, los relajantes musculares despolarizantes
              entre los mejores son la{" "}
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body>
            <IntubacionText>
              ...
              <p>
                Introducir el tubo a traves de las cuerdas vocales apoyandose de
                la curvatura del mango
              </p>
        ...
        <Accordion.Item eventKey="6">
          ...
          <Accordion.Body>
            ...
            <p>
              <em>
                La <strong>capnografia</strong>, es el metodo mas efectivo para
                valorar la correcta colocación del tubo.
              </em>
            </p>
            <Form.Check
              type="checkbox"
          ...
          <Accordion.Body>
            <ul class="list-group">
              <li class="list-group-item">
                ...
                (2013). ARTÍCULO ORIGINAL Guía para la secuencia de inducción e
                intubación rápida en el servicio de emergencias Title:
